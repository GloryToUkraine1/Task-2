...
public class main {
    ...
    // 2)
    /* На длине всего массива сравниваем элементы с другими элементами чтобы узнать наибольший и наименьший и 
     затем вычитаем из max min чтобы узнать разницу */
    ...
    // 3)
    /* Собираем сумму всех элементов в одну переменную, затем делим сумму на количество элеметов и узнем среднее арифм.
